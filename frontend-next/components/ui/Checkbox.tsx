...
export type ChoiceProps = Omit<ComponentPropsWithoutRef<"input">, "type"> & {
  label?: ReactNode;
  description?: ReactNode;
  inputClassName?: string;
};

const ChoiceControl = forwardRef<HTMLInputElement, ChoiceProps & { type: "checkbox" | "radio" }>(function ChoiceControl(
