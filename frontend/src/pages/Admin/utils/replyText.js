...
// linear, so it's safe on long inbound messages.
...
const isReplyHeader = (lines, index) => {
...
const isOutlookHeader = (lines, index) => {
...
export const extractLatestReply = (text) => {
