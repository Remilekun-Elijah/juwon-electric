...
- Not affected: the industries and hero status line changes, the client logo files and the marquee fix (entry "brand red instead of brown, industries, hero status line, client logos").
