...
- **"Chat on WhatsApp"** (sub-label "We reply during business hours"): WhatsApp green (`bg-whatsapp` #25d366, text `whatsapp-deep`) with the WhatsApp mark on a white circle (revised 2026-09-18; was a brand pill with a `MessageCircle`). Shown only when a WhatsApp number is set.
